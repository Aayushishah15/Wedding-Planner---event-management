...
public partial class AdminPhere : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into Phere(name,image)Values(@name,@image)", cn);
