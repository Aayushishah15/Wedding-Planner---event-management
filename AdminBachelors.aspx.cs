...
public partial class AdminBachelors : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into Bachelors(name,image)Values(@name,@image)", cn);
    ...
    {
        Response.Redirect("Bachelors.aspx");
    }
}