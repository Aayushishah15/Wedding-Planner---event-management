<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminReception.aspx.cs" Inherits="AdminReception" %>
...
<h4 style="font-size: xx-large; font-weight: bolder; font-style: normal; color: #F39C12; padding-top: -10px; 
        ...
        <tr>
            ...
            <td style="border-color: #F39C12">
                ...
                <asp:Button ID="Button2" runat="server" Height="43px" onclick="Button2_Click" 
                    Text="Reception Gallery" Width="210px" BackColor="White" Font-Bold="True" 
                    ForeColor="#F39C12" BorderColor="#F39C12" BorderStyle="Solid" />
            </td>
        </tr>
    </table>
    ...
    <div align="center">
    <asp:Image 
        ID="Image1" runat="server" ImageAlign="Middle" Height="250px" Width="300px" />
        </div>
    &nbsp;
    <br />
