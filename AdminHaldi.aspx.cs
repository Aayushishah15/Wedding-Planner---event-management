...
public partial class AdminHaldi : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into Haldi(name,image)Values(@name,@image)", cn);
