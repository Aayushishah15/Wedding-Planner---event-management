<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminCocktail.aspx.cs" Inherits="AdminCocktail" %>
        ...
        <tr>
            ...
            <td style="border-color: #F39C12">
                ...
                <asp:Button ID="Button2" runat="server" Height="43px" onclick="Button2_Click" 
                    Text="Pool/Cocktail Gallery" Width="210px" BackColor="White" Font-Bold="True" 
                    ForeColor="#F39C12" BorderColor="#F39C12" BorderStyle="Solid" />
            </td>
        </tr>
    </table>
