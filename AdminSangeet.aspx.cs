...
using System.Data;
using System.IO;
public partial class AdminSangeet : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into Sangeet(name,image)Values(@name,@image)", cn);
    ...
    {
        Response.Redirect("Sangeet.aspx");
    }
}