...
public partial class AdminCocktail : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into Cocktail(name,image)Values(@name,@image)", cn);
